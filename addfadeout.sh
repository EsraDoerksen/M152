# Dieses Script fügt einen Fade Out auf die Audiodatei hinzu
...
cd uploads
# Hier wird mit -i $1, die hochgeladene Audiodatei als Input definiert. Anschliessend wird mit afade ein Fade Out auf die Audiodatei hinzugefügt. $2 ist der Output
ffmpeg -i $1 -af "afade=t=out:st=5:d=5" $2
